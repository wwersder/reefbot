...
public class FishingService {
    ...
    public static String levelUnlockText(int level) {
        return switch (level) {
            ...
            case 6 -> "⚓ Ты стал Морским волком — все моря открыты, опыт растёт быстрее.";
            case 7 -> "+30% XP за рыбалку — поздние уровни стали ближе.";
            case 8 -> "+2 к максимальному улову на всех местах.";
            case 9 -> "🎣 Ты среди лучших рыбаков архипелага. Впереди — легенда.";
            case 10 -> "🔱 Легенда архипелага! Ты достиг предела мастерства рыбака.";
            default -> null;
        };
    }
