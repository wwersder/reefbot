...
const MULT = {
    8: {
        LOW:    [3.0, 1.4, 1.2, 1.0, 0.6, 1.0, 1.2, 1.4, 3.0],
        MEDIUM: [18.0, 3.0, 1.3, 0.6, 0.3, 0.6, 1.3, 3.0, 18.0],
        HIGH:   [25.0, 4.0, 1.0, 0.4, 0.2, 0.4, 1.0, 4.0, 25.0]
    },
    12: {
        LOW:    [20.0, 5.0, 2.0, 1.3, 1.0, 0.7, 0.5, 0.7, 1.0, 1.3, 2.0, 5.0, 20.0],
        MEDIUM: [33.0, 10.0, 3.0, 1.5, 0.7, 0.4, 0.2, 0.4, 0.7, 1.5, 3.0, 10.0, 33.0],
        HIGH:   [50.0, 12.0, 3.0, 1.0, 0.4, 0.2, 0.1, 0.2, 0.4, 1.0, 3.0, 12.0, 50.0]
    }
};
