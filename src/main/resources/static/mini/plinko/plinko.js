...
function slotPalette(mult) {
    if (mult >= 25) return { bg: 'rgba(255,247,237,0.85)', bgLand: 'rgba(255,237,213,0.95)', border: '#ea580c', text: '#7c2d12', glow: '#ea580c' };
...
const MULT = {
    8: {
        LOW:    [3.0,   1.5, 1.3, 1.0,  0.5,  1.0,  1.3, 1.5,  3.0],
        MEDIUM: [18.0,  3.0, 1.3, 0.6,  0.35, 0.6,  1.3, 3.0,  18.0],
        HIGH:   [25.0,  4.5, 1.1, 0.4,  0.2,  0.4,  1.1, 4.5,  25.0]
    },
    12: {
        LOW:    [20.0,  8.0,  3.0, 1.5, 1.0, 0.8, 0.5, 0.8, 1.0, 1.5, 3.0,  8.0,  20.0],
        MEDIUM: [70.0,  8.0,  2.0, 1.5, 1.0, 0.8, 0.5, 0.8, 1.0, 1.5, 2.0,  8.0,  70.0],
        HIGH:   [450.0, 13.0, 2.5, 1.0, 0.8, 0.5, 0.3, 0.5, 0.8, 1.0, 2.5, 13.0, 450.0]
    }
};
