...
- Sticky wilds, per-payline SUM mechanic: мульт применяется только к выигрышным линиям с вайлдами
...
10. **RTP балансировка v7** — пер-линейный SUM (Dog House), оригинальные иксы и 10 FS.
    - **Механика:**
      - Применение мультиплаера: глобальный SUM → **пер-линейный SUM** (вайлды только в выигрышной цепочке)
      - Вайлд-мультиплаеры: ×1/×2/×3/×5 (оригинальные, 50%/30%/15%/5%)
      - Free Spins: 10/15/20 (оригинальные)
    - **Симуляция (1M FS сессий):**
      - E[FS] = **128.71×** ставку (vs 206× с глобальным SUM — снижение на 37%)
      - Медиана: 32.8×, P75: 123.4×, P90: 334×, P99: 1377×
      - Cap 2500× срабатывает в **0.21%** сессий (vs 0.87% в v5)
    - **Текущие параметры (v7):**
      - Scatter: **0.019** → триггер ~1/591 (каждые ~89мин при 400/ч), вес от FISH_CLOWN (0.200→0.191)
      - Символьные выплаты: без изменений (Акула 22/65/200, ...)
      - **BONUS_BUY_MULTIPLIER: 134×** (E[FS]=128.71×, buy RTP=96.1%)
