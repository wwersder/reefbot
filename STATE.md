...
10. **RTP балансировка v8** — пер-линейный SUM, новая таблица выплат, бонус 100×.
    - **Механика:** пер-линейный SUM sticky wild мультов (×1/×2/×3/×5, 50%/30%/15%/5%)
    - **Симуляция (50k FS сессий):**
      - E[FS] = **97.4×** ставку | медиана 25.6× | P90 256× | P99 1025×
      - Cap 2500× срабатывает в **0.058%** сессий
    - **Текущие параметры (v8):**
      - Scatter: 0.019, WILD: 0.02 (без изменений)
      - **BONUS_BUY_MULTIPLIER: 100×** (E[FS]=97.4×, buy RTP=97.4%)
      - MAX_WIN_MULTIPLIER: 2500× за FS-сессию
      - Новые выплаты: Акула 16/48/150, Кальмар 8/22/55, Осьминог 5/13/36,
        Краб 3/8/20, СиняяРыба 2/5/12, Креветка 1.5/4/9, Рыба-шар 0.8/2.5/6, Клоун 0.5/1.5/4
